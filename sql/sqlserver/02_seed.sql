...
-- NOTA: ventas sucursal_id=2 (Occidente) viven en PostgreSQL.
--       Ver sql/postgres/04_seed_ventas.sql
-- ============================================================
...
-- ============================================================
-- VENTAS — Solo Sucursal Capital (sucursal_id = 1)
-- Occidente (sucursal_id=2) vive en PostgreSQL.
-- Empleados Capital: Elena(3-supervisora), Andrés(9), Diana(10)
-- ============================================================
...
-- ============================================================
-- DETALLE_VENTAS — Solo para ventas de Capital (ids 1-10)
-- ============================================================
...
INSERT INTO detalle_ventas (id_venta, id_producto, cantidad, precio_unitario, subtotal) VALUES
  ...
  -- Venta 3: iPhone 15 Pro (prod 4) + MacBook Air M2 (prod 8)
  ...
  -- Venta 8: Galaxy Buds2 (prod 12) + Cargador USB-C (prod 13) ×10
